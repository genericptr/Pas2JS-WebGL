...
rtl.module("GLUtils",["System","Mat4","browserconsole","Web","webgl","JS","SysUtils"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
...
rtl.module("program",["System","GLUtils","SysUtils","browserconsole","Web","webgl","JS"],function () {
  "use strict";
  var $mod = this;
  this.gl = null;
  this.shader = null;
  ...
  $mod.$main = function () {
    ...
    $mod.verts = new Array(0,0,0,0.5,0.7,0);
    $mod.buffer = $mod.gl.createBuffer();
    $mod.gl.bindBuffer($mod.gl.ARRAY_BUFFER,$mod.buffer);
    $mod.gl.bufferData($mod.gl.ARRAY_BUFFER,new Float32Array($mod.verts),$mod.gl.STATIC_DRAW);
    $mod.offset = 0;
    $mod.stride = 4 * 2;
